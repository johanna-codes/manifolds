...
%% LED-RBF Kernel
figure
load('./3-kernels/results/LED_RBF_all_delta_performance.mat')
...
%Home
%print('/media/johanna/HD1T/latex-svn/study-paper-report/ucf/v1/images/ledRBF_ker_delta_ucf_sport', '-dpng','-r300');
