function FV_ucf_sports_all_videos(Ncent, DIM, scale_factor, shift, n_videos, action_seq_names )
%%Calcular FV for all videos

%n_test =  n_videos - 1; %Problem with Run-Side_001_dim14

path  = '/home/johanna/codes/codes-git/manifolds/trunk/ucf_sports';%Donde estan las caracteristicas
